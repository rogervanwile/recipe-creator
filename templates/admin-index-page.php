    ...
    <div id="col-left">
      <div class="col-wrap">
        <form method="post" action="options.php" id="recipe-creator--settings-form">
          <input type="hidden" name="recipe_creator__primary_color_contrast" value="<?= esc_attr(
              get_option("recipe_creator__primary_color_contrast")
          ) ?>" />
          <input type="hidden" name="recipe_creator__primary_color_light" value="<?= esc_attr(
              get_option("recipe_creator__primary_color_light")
          ) ?>" />
          <input type="hidden" name="recipe_creator__primary_color_light_contrast" value="<?= esc_attr(
              get_option("recipe_creator__primary_color_light_contrast")
          ) ?>" />
          <input type="hidden" name="recipe_creator__primary_color_dark" value="<?= esc_attr(
              get_option("recipe_creator__primary_color_dark")
          ) ?>" />
          <input type="hidden" name="recipe_creator__secondary_color_contrast" value="<?= esc_attr(
              get_option("recipe_creator__secondary_color_contrast")
          ) ?>" />
          <input type="hidden" name="recipe_creator__background_color_contrast" value="<?= esc_attr(
